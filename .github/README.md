...
[`@aws-sdk/client-codecommit`](https://www.npmjs.com/package/@aws-sdk/client-codecommit/v/3.858.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-codecommit@3.858.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-V1q3ufeCpnj5XH8PJFBr1ip1DtRv5EaD6vsUGsOlXNiA1pOpjQemeLTXC+Ddemdy
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-codecommit": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-codecommit@3.858.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-codecommit@3.858.0/index.min.mjs": "sha384-V1q3ufeCpnj5XH8PJFBr1ip1DtRv5EaD6vsUGsOlXNiA1pOpjQemeLTXC+Ddemdy"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-codecommit/blob/refs/tags/3.858.0/LICENSE
```
